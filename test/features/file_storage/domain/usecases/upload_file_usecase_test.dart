  ...
  group('UploadFileUseCase', () {
    test('should upload file successfully', () async {
      ...
      when(() => mockFileRepository.uploadFile(
          ...
          )).thenAnswer((_) async => Result.success(testFileEntity));
      ...
      expect(result.data, testFileEntity);
    ...
    test('should pass all parameters correctly', () async {
      ...
      when(() => mockFileRepository.uploadFile(
        ...
        progressCallback?.call(UploadProgressEntity(
          fileId: 'test-id',
          uploadedBytes: 50,
          totalBytes: 100,
          status: UploadStatus.uploading,
        ));
        return Result.success(testFileEntity);
      });
