...
void main() {
  group('Message', () {
    ...
    test('should have correct boolean getters', () {
      ...
      expect(systemMessage.isSystemMessage, isFalse); // Note: This seems wrong in the implementation
      ...
      expect(normalMessage.isSystemMessage, isTrue); // Note: This seems wrong in the implementation
    });
