...
void main() {
  ...
  group('UploadProgressEntity', () {
    ...
    setUp(() {
      progressEntity = const UploadProgressEntity(
        fileId: 'file-123',
        uploadedBytes: 500,
        totalBytes: 1000,
    ...
    test('should create upload progress entity with all properties', () {
      ...
      expect(progressEntity.eta, const Duration(seconds: 30));
    ...
    test('should format speed correctly', () {
      ...
      const nullSpeedProgress = UploadProgressEntity(
        fileId: 'test',
        uploadedBytes: 0,
        totalBytes: 100,
        status: UploadStatus.uploading,
